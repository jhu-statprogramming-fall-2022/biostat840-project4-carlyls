...
In this analysis, we will be displaying an example of rpart applied to the horror films dataset. We will be using rpart to develop a model that predicts rating based on some factors of the movie. We are therefore working to answer the question, what factors of horror movies make them more likely to have a good rating? The visuals in the other tabs on this dashboard provide a helpful background for developing this model.
